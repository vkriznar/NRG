...
namespace PathTracer
{
  public class Scene
  {
    ...
    public static Scene CornellBox()
    {
            ...
            el.BSDF.Add(new OrenNayar(Spectrum.ZeroSpectrum.FromRGB(Color.White)));
            s.Elements.Add(el);
            ...
            el.BSDF.Add(new OrenNayar(Spectrum.ZeroSpectrum.FromRGB(Color.Green)));
            s.Elements.Add(el);

            //left
            el = new Quad(559.2, 548.8, Transform.Translate(0, 548.8/2, 559.2/2).A(Transform.RotateY(-90)));
            el.BSDF.Add(new OrenNayar(Spectrum.ZeroSpectrum.FromRGB(Color.Red)));
            s.Elements.Add(el);

            s.Elements.Add(new DiffuseAreaLight(new Disk(85, 0.1, Transform.Translate(278, 548, 280).A(Transform.RotateX(90))), Spectrum.Create(1), 20));
            //s.Elements.Add(new DiffuseAreaLight(new Sphere(65, Transform.Translate(278, 548, 280)), Spectrum.Create(1), 20));

            el = new Quad(200, 200, Transform.Translate(150, 100, 420));
            el.BSDF.Add(new OrenNayar(Spectrum.ZeroSpectrum.FromRGB(Color.Blue)));
            s.Elements.Add(el);

            el = new Sphere(100, Transform.Translate(400, 100, 230));
            //el = new Quad(200, 200, Transform.Translate(400, 100, 230));
            ...
            el.BSDF.Add(new OrenNayar(Spectrum.ZeroSpectrum.FromRGB(Color.Yellow)));
            s.Elements.Add(el);
